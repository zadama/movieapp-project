    ...
    return (
        <div onClick={() => showMovie(theMovie.id)} className="movie-card">
            ...
            {theMovie.poster_path ? (
                <img src={baseImageURL + theMovie.poster_path} alt={theMovie.original_title}></img>

            ) : (
                    <span style={{ width: "100%", height: "300px" }}>
                        <p style={{ fontSize: "3.7rem", textAlign: "center" }}>{theMovie.original_title.substr(0, 1)}</p>
                    </span>
                )}
